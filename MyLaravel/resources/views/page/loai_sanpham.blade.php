								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											@if($sp->promotion_price==0)
												<span class="flash-del" style="text-decoration:none">{{number_format($sp->unit_price)}} đồng</span>
											@else
								...
								@if($spk->promotion_price!=0)
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price" style="font-size:18px">
											@if($spk->promotion_price==0)
												<span class="flash-del" style="text-decoration:none">{{number_format($spk->unit_price)}} đồng</span>
											@else
