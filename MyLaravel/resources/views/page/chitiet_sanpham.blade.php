							...
							<div class="single-item-body">
								...
								<p class="single-item-price">
									@if($sanpham->promotion_price==0)
										<span class="flash-del" style="text-decoration:none">{{number_format($sanpham->unit_price)}} đồng</span>
									@else
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-body">
										...
										@if($sptt->promotion_price==0)
											<span class="flash-del" style="text-decoration:none">{{number_format($sptt->unit_price)}} đồng</span>
										@else
